...
try {
  if(currentUser?.location && currentUser?.interests){
  ...
  return (
    <div className="flex items-center">
      <div className="relative flex w-full" ref={searchRef}>
        <div className="flex-1">
          ...
          <Input
            ...
            onFocus={() => {
              if (searchQuery.length >= 3) setShowSearchResult(true);
            }}
      ...
      >
        <SelectTrigger  className="h-9 w-ful32 rounded-none rounded-r-md">
          <SelectValue
            placeholder= "City"
          />
        </SelectTrigger>
