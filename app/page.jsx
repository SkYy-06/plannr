        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center relative z-10">
          ...
          <div className="text-center sm:text-left">
            ...
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-bold mb-6 leading-0.95] tracking-tight">
              ...
              create amazing
              <br />
              <span className="bg-linear-to-r from-blu400 via-purple-400 to-orange-400 bg-clip-text text-transparent" >event.</span>
            </h1>
            <p className="text-lg sm:text-xl text-gray-400 mb-12 max-w-lg font-light">
              Whether you're hosting or attending, Plannr makes every event
